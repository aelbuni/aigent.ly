...
import { NAV_DATA } from "./data/aigently-nav";
...
export function Sidebar({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- only expand when route changes
  }, [pathname]);
      ...
      >
        <div className="flex h-full flex-col py-10 pl-[25px] pr-[7px]">
          <div className="relative pr-4.5">
            <Logo onClick={isMobile ? toggleSidebar : undefined} />
