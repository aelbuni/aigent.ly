...
import { assignThreatLayers } from "./lib/assign-threat-layers";
...
async function main() {
  ...
  try {
    ...
    // ── Phase 6b: Auto-assign threat→layer rows ───────────────────────
    console.log("Phase 6b: assigning threat layers...");
    await assignThreatLayers(updatedIds);
